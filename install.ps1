...
# One-liner:
#   Set-ExecutionPolicy -ExecutionPolicy Bypass -Scope Process -Force; irm https://github.com/Pedrofariaeva/claudito-releases/releases/download/v2.2.24/install.ps1 | iex

$ErrorActionPreference = "Stop"

$ReleaseRepo = "Pedrofariaeva/claudito-releases"
$Version = "v2.2.24"
$ZipName = "claudito-external-v2.2.24-windows.zip"
...
try {
    ...
    $ExtractedDir = Join-Path $TempDir "claudito-external-v2.2.24"
